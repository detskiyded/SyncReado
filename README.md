...
| Закладки (frontend UI) | 🔵 В работе |
| Визуальные индикаторы закладок | 🔵 В работе |
| Система друзей | ⚪ Запланировано |
| Real-time синхронизация (WebSocket) | ⚪ Запланировано |
| Совместные режимы чтения | ⚪ Запланировано |
